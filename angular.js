 ...
 * - `scope()` - retrieves the {@link controllers/ng.$rootScope.Scope scope} of the current
...
function $RouteProvider(){
   ...
   *        Otherwise if function, then it is {@link controllers/AUTO.$injector#invoke injected}
